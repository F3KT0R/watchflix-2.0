...
export const ContentDesktop = ({
  ...
  return (
    <div>
      <div className='grid grid-cols-10 pt-8 bg-transparent bg-gradient-to-l from-black'>
        ...
        <div className='grid col-span-2 grid-rows-6 p-4 items-center justify-center text-center'>
        ...
        <div className='grid col-span-10 3xl:grid-cols-6 p-5'>
          {data &&
            data.map((item) => {
              return (
                <div
